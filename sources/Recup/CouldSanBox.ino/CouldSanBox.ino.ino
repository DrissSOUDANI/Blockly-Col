...
#include <LDateTime.h>
#define WIFI_AP "Freebox-7E4999"
#define WIFI_PASSWORD "fornice-actuario2!-exsurrexi*-accelerand"
#define WIFI_AUTH LWIFI_WPA  // choose from LWIFI_OPEN, LWIFI_WPA, or LWIFI_WEP.
#define per 50
#define per1 3
#define DEVICEID "DUmoahWS" // Input your deviceId
#define DEVICEKEY "B8USp6wdV5HvveJD" // Input your deviceKey
...
String upload_led;
String tcpcmd_led_on = "Interrupteur_4,1";
String tcpcmd_led_off = "Interrupteur_4,0";
...
void uploadstatus(){
  ...
  delay(100);
  if(digitalRead(13)==1)
  upload_led = "LED_Rouge,,1";
  else
  upload_led = "LED_Rouge,,0";
