...
Blockly.Arduino.technozone_wf_setup = function() {
  ...
  Blockly.Arduino.definitions_['define_lire_octet'] = 'void WF_setup(){\n'+
...
Blockly.Arduino.technozone_wf_led = function() {
  ...
  var code = 'wf.println("write '+field+' '+colorwf+'");\n'+
              'delay(300);\n';
  return code;
};
...
Blockly.Arduino.technozone_wf_potar = function() {
  ...
  var position = Blockly.Arduino.valueToCode(this, 'POSITION',
            Blockly.Arduino.ORDER_UNARY_POSTFIX);                                            
  var code = 'wf.println("write '+field+' '+position+'");\n'+
              'delay(300);\n';
  return code;
};
...
Blockly.Arduino.technozone_wf_potar_read = function() {                                
  var code = 'field_value.toInt()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.technozone_wf_edit_read = function() {                                
  var code = 'field_value';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_wf_switch = function() {
  ...
  var code = 'field_no=="'+field+'"&&field_value.startsWith("'+logique+'",0)';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_wf_btn = function() {
  var field = Blockly.Arduino.valueToCode(this, 'FIELD',
            Blockly.Arduino.ORDER_UNARY_POSTFIX);                                 
  var code = 'field_no=="'+field+'"&&field_value.startsWith("true",0)';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_wf_btn_reset = function() {
  var field = Blockly.Arduino.valueToCode(this, 'FIELD',
            Blockly.Arduino.ORDER_UNARY_POSTFIX);                                  
  var code = 'wf.println("write '+field+' false");\n'+
              'delay(300);\n';
  return code;
};

Blockly.Arduino.technozone_wf_reset = function() {
  var code = 'wf_enabled=false;\n';
  return code;
};
...
Blockly.Arduino.technozone_wf_init = function() {
  ...
  Blockly.Arduino.definitions_['define_SoftwareSerial'] = "#include <SoftwareSerial.h>\n"; 
  Blockly.Arduino.definitions_['define_TimerOne'] = "#include <TimerOne.h>\n";
  Blockly.Arduino.definitions_['define_var_wf'] = "SoftwareSerial wf("+dropdown_RX_pin+","+dropdown_TX_pin+"); // RX, TX\n"; 
  Blockly.Arduino.definitions_['define_var_wf_enabled'] = "boolean wf_enabled=false;\n";
  Blockly.Arduino.definitions_['define_var_time_out'] = "boolean time_out;\n";
  Blockly.Arduino.definitions_['define_var_incomingByte'] = "int incomingByte = 0;\n";  
  Blockly.Arduino.definitions_['define_var_stringwf'] = 'String stringwf = "";\n';
  Blockly.Arduino.definitions_['define_var_field_no'] = 'String field_no = "";\n';
  Blockly.Arduino.definitions_['define_var_field_value'] = 'String field_value = "";\n';
  Blockly.Arduino.definitions_['define_var_intflag'] = 'volatile boolean intflag =false;\n';
  //dans fonctions
 Blockly.Arduino.definitions_['define_fetch_cmd'] = 'void fetch_cmd(){\n'+ 
 ...
 ' } \n'+
 '}\n';
 Blockly.Arduino.definitions_['define_WFinterrupt'] = 'void WFinterrupt() {\n'+
  ' if (!intflag) {\n'+
  '  intflag=true;\n'+
  '  if (wf.available()>0) {\n'+
  '          // read the incoming byte:\n'+
  '              incomingByte = wf.read();\n'+
  '              if (incomingByte==10) {\n'+
  '                fetch_cmd();\n'+
  '                stringwf="";\n'+
  '              } else {\n'+
  ...
  //dans setup    
  Blockly.Arduino.setups_['setup_wf'] = 'wf.begin(9600);';   
  Blockly.Arduino.setups_['setup_Timer1_initialize'] = 'Timer1.initialize(10000);'; 
  Blockly.Arduino.setups_['setup_Timer1_attachInterrupt'] = 'Timer1.attachInterrupt(WFinterrupt);'; 
...
Blockly.Arduino.technozone_robot_ligleft = function() {
  ...
  Blockly.Arduino.definitions_['define_var_LigLevel'] = "int LigLevel=800;\n";    
  var code = 'analogRead(A2)>LigLevel';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_robot_ligright = function() {
  ...
  Blockly.Arduino.definitions_['define_var_LigLevel'] = "int LigLevel=800;\n";     
  var code = 'analogRead(A0)>LigLevel';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_DS1307_initDate = function() {
  ...
  Blockly.Arduino.definitions_['define_Wire'] = '#include <Wire.h>';
  Blockly.Arduino.definitions_['define_ds1307'] = "#include <DS1307new.h>\n";
  
  var code =  "RTC.stopClock();\n"+
              "RTC.fillByYMD("+value_annee+","+value_mois+","+value_jour+");\n"+
              "RTC.setTime();\n"+
              "RTC.startClock();\n"; 
  return code;
};
...
Blockly.Arduino.technozone_DS1307_initTime = function() {
  ...
  var code =  "RTC.stopClock();\n"+
              "RTC.fillByHMS("+value_heure+","+value_minute+","+value_seconde+");\n"+
              "RTC.setTime();\n"+
              "RTC.startClock();\n"; 
  return code;
};
...
Blockly.Arduino.technozone_DS1307_readTime = function() { 
  ...
  Blockly.Arduino.definitions_['define_digit2'] = "String digit2(int n)\n"+
    "{\n"+
    " String temp;\n"+
    " if (n<10) {\n"+
    '   temp="0"+String(n);\n'+
  ...
  Blockly.Arduino.definitions_['define_getFormatedTime'] = "String getFormatedTime()\n"+
    "{\n"+
    "  RTC.getTime();\n"+
    '  return digit2(RTC.hour)+":"+digit2(RTC.minute)+":"+digit2(RTC.second);\n'+
    "}\n";
  
  var code =  "getFormatedTime()"; 
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_DS1307_readDate = function() { 
  ...
  Blockly.Arduino.definitions_['define_getFormatedDate'] = "String getFormatedDate()\n"+
    "{\n"+
    "  RTC.getTime();\n"+
    '  return digit2(RTC.day)+"/"+digit2(RTC.month)+"/"+digit2(RTC.year-2000);\n'+
    "}\n";
  
  var code =  "getFormatedDate()"; 
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_DS1307_read = function() { 
  ...
  Blockly.Arduino.definitions_['define_getDTitem'] = "int getDTitem(byte n)\n"+
    "{\n"+
    "  RTC.getTime();\n"+
    "  switch(n){\n"+
    "   case 1 :\n"+
  ...
  var code =  "getDTitem("+dropdown_item+")"; 
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};
...
Blockly.Arduino.technozone_robot_move = function() {
  ...
  Blockly.Arduino.definitions_['define_vmax'] = 'int vmax=253;            //vitesse maximale des moteurs\n';
  //dans fonctions    
...
Blockly.Arduino.technozone_robot_turn = function() {
  ...
  Blockly.Arduino.definitions_['define_Pap1'] = '#include <Pap1.h>';
  Blockly.Arduino.definitions_['define_Stepper'] = 'Pap1 Stepper(23);\n'; 
  Blockly.Arduino.definitions_['define_step_per_degre'] = '#define step_per_degre 10.36   //Nombre de pas pour tourner de 1°\n';    
  Blockly.Arduino.definitions_['define_vmax'] = 'int vmax=253;            //vitesse maximale des moteurs\n';    
  //dans le setup    
  Blockly.Arduino.setups_["setup_Wire"] = "Wire.begin(); // join i2c bus";
  Blockly.Arduino.setups_["setup_Stepper"] = 'Stepper.Begin(SINGLE_STEPPING,AUTO_RELAX);\n'+
...
Blockly.Arduino.technozone_robot_speed = function() {
  ...
  Blockly.Arduino.setups_["setup_Stepper"] = 'Stepper.Begin(SINGLE_STEPPING,AUTO_RELAX);\n'+
      '  Stepper.SetMode(IDLE);';
  //dans loop    
  var code = 'vmax='+value_vitessemax+';\n';
  return code;
};
