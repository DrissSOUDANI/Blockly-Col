...
/*Blocs ajoutés par Driss Dans /BlocklyArduino/loops  pour compléter la catégorie loops d'origine */
Blockly.Arduino.controls_base_delay = function() {
  var delay_time = Blockly.Arduino.valueToCode(this, 'DELAY_TIME', Blockly.Arduino.ORDER_ATOMIC);
  var code = 'delay(' + delay_time + ');\n';
  return code;
};

Blockly.Arduino.controls_repeat_indefinitely = function() {
