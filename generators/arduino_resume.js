...
function() {
    // Call a function when done
    console.log("Done loading Driss Variables Generators");
});



head.load(
"generators/arduino/drissA4.js",
function() {
    // Call a function when done
    console.log("Done loading Driss A4 Generators");
});


head.load(
"generators/arduino/drissGrove.js",
function() {
    // Call a function when done
    console.log("Done loading Driss Grove Generators");
});


head.load(
"generators/arduino/drissLinkItOne.js",
function() {
    // Call a function when done
    console.log("Done loading Driss Link It One Generators");
});

head.load(
"generators/arduino/drissTinkerKit.js",
function() {
    // Call a function when done
    console.log("Done loading Driss Tinker Kit Generators");
});
...
head.load(
"generators/arduino/drissAutres.js",
function() {
    // Call a function when done
